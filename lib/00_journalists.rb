...
#number of handle in array
def size(array)
    array.size
end
puts size(journalists)
...
#Array sort by a <-> b
def sort_by_a_b(array)
    array.sort {|a, b| a <=> b }
end
puts sort_by_a_b(journalists)
...
#Position of handle "@epenser"
def position_of_handle(array)
    array.index {|handle| handle == "@epenser"}
end
puts position_of_handle(journalists)

def position_of_handle2(array)
    array.index("@epenser")
end
